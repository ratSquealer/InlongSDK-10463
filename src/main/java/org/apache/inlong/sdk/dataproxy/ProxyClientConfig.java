...
public class ProxyClientConfig {
    // ------------------------
    private static ProxyClientConfig instance;
...
//        String protocolType = ConfigConstants.HTTPS;
        String protocolType = ConfigConstants.HTTP;
        if (requestByHttp) {
...
// -------------------------------------------------------------------------
    private ProxyClientConfig() {
        this.maxMessageLength = ConfigConstants.DEFAULT_MAX_MESSAGE_LENGTH; // 设置默认值
        this.enableTruncation = ConfigConstants.DEFAULT_ENABLE_TRUNCATION; // 设置默认截断选项
    }

    public static ProxyClientConfig getInstance() {
        if (instance == null) {
            instance = new ProxyClientConfig();
        }
        return instance;
    }
    ...
    public void setEnableTruncation(boolean enableTruncation) {
        this.enableTruncation = enableTruncation;
    }
}
